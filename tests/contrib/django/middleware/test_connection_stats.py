...
TEST_PROC_NET_TCP = '''  sl  local_address rem_address   st tx_queue rx_queue tr tm->when retrnsmt   uid  timeout inode
   ...
   1: 00000000:18EB 00000000:0000 0A 00000000:00000000 00:00000000 00000000   999        0 1041801 1 0000000000000000 100 0 0 10 0
   ...
   4: 0100007F:8772 0100007F:18EB 06 00000000:00000000 03:000015D6 00000000     0        0 0 3 0000000000000000
   5: 0100007F:8770 0100007F:18EB 01 00000000:00000000 03:000015AD 00000000     0        0 0 3 0000000000000000'''
...
class ConnectionStatsMiddlewareTest(TestCase):
    ...
    def test_middleware(self, mock_gauge):
        ...
        mock_file_patch = mock_open_patch(TEST_PROC_NET_TCP)
